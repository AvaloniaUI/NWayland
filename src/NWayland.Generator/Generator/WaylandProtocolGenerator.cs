...
namespace NWayland.Generator
{
    public partial class WaylandProtocolGenerator
    {
        ...
        //  - Release (what we pack to NuGet): include "#pragma warning disable" so downstream
        //    consumers never get warnings from generated code they cannot hand-edit.
        //  - Debug (local generator builds): omit it, so any warning our generator accidentally
        //    emits surfaces in our own build under TreatWarningsAsErrors and we fix it at the source.
